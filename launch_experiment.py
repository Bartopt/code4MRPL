...
def experiment(variant):
    ...
    algorithm = PEARLSoftActorCritic(
        env=env,
        train_tasks=list(tasks[:variant['n_train_tasks']]), # the front of list is training tasks
        eval_tasks=list(tasks[-variant['n_eval_tasks']:]), # the back of list is evaluating tasks
