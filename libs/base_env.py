...
# this class is used to study how state representation influence the performance of reinforcement learning algorithms.
class BaseGymEnv(gym.Env):
    ...
    def __init__(self, *, srl_model, relative_pos, env_rank, pipe):
        """
    ...
    def getSRLState(self, observation):
        ...
        if self.srl_model == "ground_truth":
            ...
            self.pipe[0].put((self.env_rank, observation))
            return self.pipe[1][self.env_rank].get()
